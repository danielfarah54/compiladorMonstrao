...
public class CronoTaskGeradorHTML extends RegrasBaseVisitor<Void> {
    ...
    public Void visitPrograma(RegrasParser.ProgramaContext ctx) {
        ...
        for(Quantidade de task){
            ...
            saida.append(ctx.numero_da_task_portfolioModal1);
            saida.append("
                            \">\n
            ...
            saida.append(ctx.nome_da_task_portfolioModal1);
            saida.append("</h4>\n<p class=\"text-muted\">");
            saida.append(ctx.subtitulo_da_task_portfolioModal1);       
            saida.append("</p>\n</div>\n</div>");
        }
        ...
        for(Quantidade_de_task){
            ...
            saida.append(ctx.descricao_da_task_portfolioModal1);
            saida.append("                                    
                            </p>\n
            ...
            saida.append(ctx.link_localizacao_da_task_portfolioModal1);
            saida.append("
                                        \"
